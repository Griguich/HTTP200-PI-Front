...
export class CommentaireService {
  ...
  assignCommentaireToPub(commentaire: Commentaire,idPub:number, userId: number): Observable<Commentaire> {
    return this.http.post<Commentaire>(`${this.baseUrl}/AssignCommentaireToPub/${idPub}/${userId}`, commentaire);
  }
